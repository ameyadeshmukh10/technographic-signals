...
| Metric | Count |
|---|---:|
| **Total vendors in the library** | **7,529** |
| Detectable via the **JS / Web pipeline** | 7,444 |
| Detectable via the **DNS pipeline** | 90 |
| Hand-curated, high-precision signatures | 38 |
...
### Marketing Automation & Messaging  ·  729 vendors
_Lifecycle, email, and campaign engines._  (web: 718 · DNS: 20)

| Category | Vendors | DNS | Notable |
|---|---:|---:|---|
| Marketing automation | 500 | 10 | Customer.io★, HubSpot★, Klaviyo★, Marketo★, Salesforce Marketing Cloud Account Engagement (Pardot)★, Campaign Monitor★, Postmark★, Salesloft★, 6sense, ActiveCampaign, Braze, Constant Contact |
...
| Postmark | `postmark` | TXT/CNAME/MX |
